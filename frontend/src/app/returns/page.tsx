                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      <Link href={`/orders/${r.orderId}`} className="text-xs text-indigo-600 hover:text-indigo-700 inline-flex items-center gap-1">Order <ExternalLink className="w-3 h-3" /></Link>
                    </div>
