          ...
          >
            ...
            <div className="p-4">
              <Link href={`/listings/${item.id}`}>
                <h3 className="font-semibold text-gray-900 truncate hover:text-indigo-600 transition-colors">{item.title}</h3>
              </Link>
              <div className="mt-2 flex items-center justify-between">
                <span className="font-bold text-indigo-600">{formatPrice(item.priceMinorUnits)}</span>
                <button
