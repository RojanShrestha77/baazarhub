  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex items-center justify-between mb-6">
        ...
        <Link href="/marketplace" className="text-sm text-indigo-600 hover:text-indigo-700 font-medium inline-flex items-center gap-1"><ArrowLeft className="w-4 h-4" /> Continue Shopping</Link>
      </div>
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-xl border border-gray-100 p-5 shadow-sm sticky top-24">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex justify-between text-base"><span className="font-semibold text-gray-900">Total</span><span className="font-bold text-indigo-600">{formatPrice(cart?.totalMinorUnits || 0)}</span></div>
            </div>
            <Link href="/checkout" className="mt-5 block w-full bg-indigo-600 text-white text-center py-3 rounded-xl font-semibold hover:bg-indigo-700 transition-all active:scale-[0.98] shadow-sm">
              Proceed to Checkout
            </Link>
