    ...
    <div className="max-w-3xl mx-auto px-4 py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          ...
          <Link key={h.title} href={h.link} className="p-6 bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md hover:border-indigo-100 transition-all">
