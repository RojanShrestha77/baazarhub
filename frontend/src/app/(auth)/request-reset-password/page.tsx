        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          {sent ? (
            <div className="text-center">
              ...
              <Link href="/login" className="text-sm text-indigo-600 hover:text-indigo-700 font-medium">Back to login</Link>
            </div>
          ) : (
            <>
              ...
              <p className="mt-6 text-center text-sm text-gray-400"><Link href="/login" className="text-indigo-600 hover:text-indigo-700 font-medium">Back to login</Link></p>
            </>
          )}
        </div>
      </motion.div>
